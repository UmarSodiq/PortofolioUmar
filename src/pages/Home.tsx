...
import { Github, Linkedin, Mail, Instagram, Heart, Globe, LucideIcon } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen font-sans text-zinc-900 dark:text-zinc-50 transition-colors duration-300 overflow-x-hidden">
      ...
      <main>
        ...
        <Section id="statistik" title="Data & Statistics" className="transition-colors duration-300">
          <DataDashboard />
        </Section>
